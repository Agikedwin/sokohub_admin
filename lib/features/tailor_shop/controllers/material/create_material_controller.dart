...
class CreateMaterialController extends GetxController {
  ...
  static CreateMaterialController get instance => Get.find();
      ...
      if (!formKey.currentState!.validate()) {
        ...
        final newRecord = MaterialModel(
          id: '',
           ...
           newRecord.id =  await MaterialRepository.instance.createMaterial(newRecord);
