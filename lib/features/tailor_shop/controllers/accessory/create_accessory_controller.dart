...
class CreateAccessoryController extends GetxController {

  static CreateAccessoryController get instance => Get.find();
  ...
  Future<void> createAccessory() async {
    ...
    try {
      ...
      if (!formKey.currentState!.validate()) {
        ...
        final newRecord = AccessoryModel(
          id: '',
           name: name.text.trim(), 
           image: imageURL.value,
           unitCost: double.parse(unitCost.text.trim().toString()),
           createdAt: DateTime.now()
           );

          
           newRecord.id =  await AccessoryRepository.instance.createAccessory(newRecord);

           // Update Data list

           AccessoryController.instance.addItemTolist(newRecord);
