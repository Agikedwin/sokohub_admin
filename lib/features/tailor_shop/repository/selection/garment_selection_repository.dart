...
/// Firebase Firestore Instance
  ...
  Future<List<ClientSelectionAttributesModel>> getAllGarmentSelections() async {
    ...
    } on TFirebaseException catch (e, trace) {
       print(trace);
      print(e);
  ...
  Future<String> createGarmentSelection(ClientSelectionAttributesModel material) async {
    try {
      final data = await _db.collection('ClientSelectionOrder').add(material.toJson());
      return  data.id;
  ...
  Future<ClientSelectionAttributesModel> updateGarmentSelection(ClientSelectionAttributesModel material) async {
    try {
      await _db
