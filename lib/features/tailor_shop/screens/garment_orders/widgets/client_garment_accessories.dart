...
class ClientGarmentAccessories extends StatelessWidget {
  const ClientGarmentAccessories({
    super.key,
    //required this.order,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final accessory = controller.clientGarmentSelection.value.accessories;

      final subTotal = accessory.fold(
          0.0,
          (previousvalue, element) =>
              previousvalue + (element.unitCost * element.quantity!));
                              ...
                              child: Row(
                                children: [
                                  ...
                                  SizedBox(
                                    width: TSizes.xl * 2,
                                    child: Text(
                                      item.unitCost.toStringAsFixed(1),
                                      style:
