...
import 'package:sokohub_admin/features/tailor_shop/screens/quantity_cost/all_accessories/table/accessories_quantity_cost_data_table.dart';
...
class AccessoryQuantityCostTabletScreen extends StatelessWidget {
  const AccessoryQuantityCostTabletScreen({super.key});
            ...
            children: [
              ...
              TRoundedContainer(
                child: Column(
                  ...
                  // Table Header
                 children: [
                    ITTableHeader(buttonText: '', onPressed: ()  => Get.toNamed(ITRoutes.createGarmentSelection),
              ...
              Obx((){ 
                    ...
                    return const AccessoryQuantityCostTable();
                    }),
                 ],
