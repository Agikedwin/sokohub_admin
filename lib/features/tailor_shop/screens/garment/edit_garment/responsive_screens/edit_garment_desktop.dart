...
class EditGarmentDesktopScreen extends StatelessWidget {
  const EditGarmentDesktopScreen({super.key, required this.garment});
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Breadcrumbs
              const TBreadcrumbsWithHeading(returnToPreviousScreen: true, heading: 'Update Garment', breadcrumbItems: [ITRoutes.garment, 'Garment']),
