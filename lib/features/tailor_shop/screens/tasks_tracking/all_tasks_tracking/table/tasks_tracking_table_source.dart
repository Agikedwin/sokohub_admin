      ...
      cells: [
        DataCell(
         ...
         DataCell(
            ...
            child: SingleChildScrollView(
              ...
              child: Wrap(
                ...
                .map((e) => Padding(
                    ...
                    child:  Chip(label: Text(e.firstName), padding: EdgeInsets.all(TSizes.xs),),
                  ),).toList()
                  : [const SizedBox()]
              ) 
            ),
          ...
          DataCell(tasksTracker.status == 'Pending'  ? const Icon(Iconsax.timer_1, color: TColors.primary,) : const Icon(Iconsax.tick_circle, color: TColors.success,)),
           DataCell(Text(tasksTracker.formattedDate)),
              DataCell(TTableActionButtons(
                onEditPressed: () => Get.toNamed(ITRoutes.editBrand, arguments: tracking),
